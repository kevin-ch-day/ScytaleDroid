#!/usr/bin/env python3
"""Read-only Phase B1 preflight and planned SQL bundle for join-key normalization."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = collect_phase_b1_join_key_preflight(core_q.run_sql, sample_limit=max(1, min(int(args.sample_limit), 100)))
