...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if check_db_enabled(db_config, "DB disabled; static dangling audit needs the core database."):
            return 2
        ...
        output_dir = Path(args.output_dir) if args.output_dir else default_output_dir(_REPO_ROOT, "artifact_registry_static_dangling")
