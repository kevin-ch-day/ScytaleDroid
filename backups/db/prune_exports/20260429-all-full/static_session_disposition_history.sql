...
LOCK TABLES `static_session_disposition_history` WRITE;
/*!40000 ALTER TABLE `static_session_disposition_history` DISABLE KEYS */;
INSERT INTO `static_session_disposition_history` VALUES
(2,2,NULL,'broken_persist_error_session','initial session summary backfill from static_analysis_runs','manual_sql','{\"session_status\":\"FAILED\",\"cleanup_status\":\"export_pending\",\"web_visibility_default\":\"hidden\",\"total_run_count\":120,\"completed_run_count\":0,\"failed_run_count\":120}','2026-05-11 17:39:40');
/*!40000 ALTER TABLE `static_session_disposition_history` ENABLE KEYS */;
UNLOCK TABLES;
