...
def test_gap_rows_do_not_treat_resolved_third_party_as_context_debt() -> None:
    rows = report._gap_rows(
        [
            {
                "package_name": "com.snapchat.android",
                "display_name": "Snapchat",
                "manual_runs": 3,
                "static_dynamic_domain_gap": False,
            }
        ],
        [
            {
...
def test_gap_rows_still_flag_unknown_domains_as_context_debt() -> None:
    rows = report._gap_rows(
        [
            {
                "package_name": "com.snapchat.android",
        ...
        [
            {
                "package_name": "com.snapchat.android",
                "domain": "unclassified.example.net",
                "owner_class": "unknown",
                "role_class": "unknown",
                "basis": "unclassified",
            }
    ...
    assert rows[0]["needs_context"] == 1
    assert rows[0]["unknown_domain_count"] == 1
    assert rows[0]["third_party_domain_count"] == 0
    assert rows[0]["notes"] == "unknown_domains=1"
