...
def test_resolve_service_for_domain_prefers_package_specific_scope() -> None:
    ...
    assert pinterest_appsflyer_inapps["service_key"] == "appsflyer"
    assert pinterest_appsflyer_inapps["service_category"] == "attribution"
    assert pinterest_appsflyer_inapps["role_class"] == "attribution_measurement"

    pinterest_appsflyer_launches = service_context.resolve_service_for_domain(
        "jarlio.launches.appsflyersdk.com",
        package_name="com.pinterest",
        service_rows=services,
        map_rows=maps,
    )
    assert pinterest_appsflyer_launches["service_key"] == "appsflyer"
