...
def test_messaging_interaction_suppresses_quiet_low_signal_when_structurally_valid(tmp_path: Path) -> None:
...
def test_connected_baseline_keeps_low_signal_when_evidence_dimensions_are_weak(tmp_path: Path) -> None:
    run_dir = tmp_path / "run"
    _write_json(
        run_dir / "analysis" / "pcap_features.json",
        {
