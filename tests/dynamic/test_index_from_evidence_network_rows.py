...
def test_build_dynamic_network_features_row_prefers_tracker_countability_truth(
...
def test_build_dynamic_network_features_row_uses_paper_exclusion_reason_for_valid_supplemental_run(
    tmp_path,
):
    from scytaledroid.DynamicAnalysis.storage import index_from_evidence
...
def test_build_dynamic_network_features_row_backfills_transport_lifecycle_from_pcap(
    monkeypatch, tmp_path
):
    from scytaledroid.DynamicAnalysis.storage import index_from_evidence
...
def test_build_dynamic_network_features_row_uses_pcap_features_summaries_when_report_blocks_missing(
    tmp_path,
):
    from scytaledroid.DynamicAnalysis.storage import index_from_evidence
