...
- tests needed:
  - keep `tests/database/test_artifact_registry_typed_linkage.py`
  - keep `tests/database/test_phase_a_typed_read_parity.py`
...
- `tests/database/test_schema_migration_governance.py`
- `tests/database/test_report_canonical_schema_map.py`
- `tests/database/test_phase_a_typed_read_parity.py`
- `tests/database/test_artifact_registry_typed_linkage.py`
- `tests/database/test_report_artifact_registry_integrity.py`
- `tests/database/test_report_artifact_registry_dynamic_dangling.py`
- `tests/database/test_artifact_registry_dynamic_prune.py`
