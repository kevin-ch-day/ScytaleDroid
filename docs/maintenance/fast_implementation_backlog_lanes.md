...
| B‑helper‑runs‑1 | 2 | `legacy_runs_count_by_session_stamp` + wiring report | `legacy_static_mirror_diagnostics.py`, `audit_static_session.py`, `legacy_mirror_helper_wiring_report.md` | `runs` count SQL deduped | Low | DB unit tests | Revert helper call | **This batch** |
