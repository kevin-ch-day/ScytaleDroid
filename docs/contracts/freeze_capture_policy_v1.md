# Freeze Capture Policy v1

This document defines the freeze/profile dynamic collection contract referenced by:
...
4. Identity contract (freeze/profile mode)
...
- freeze gate must reject missing/mismatched capture policy versions
