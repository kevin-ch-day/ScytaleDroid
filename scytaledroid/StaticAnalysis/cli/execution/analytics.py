...
def _build_permission_profile(report, app_result) -> dict[str, object | None]:
    declared_pairs, _sdk, target_sdk, allow_backup_flag, legacy_storage_flag = _resolve_perm_inputs(
        report=report,
        sdk=None,
        declared=None,
    )
    ...
    return {
        ...
        "noteworthy_permissions": sorted(noteworthy_normals_set),
        "special_risk_permissions": sorted(special_risk_normals_set),
    }
