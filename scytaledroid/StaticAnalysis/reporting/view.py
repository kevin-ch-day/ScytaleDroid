...
def _normalise_parser_provenance(metadata: Mapping[str, Any]) -> Mapping[str, Any]:
    ...
    return {
        ...
        "resource_parse_state": parser.get("resource_parse_state") or "none",
        "resource_parse_partial": bool(parser.get("resource_parse_partial")),
        "resource_reparse_candidate": bool(parser.get("resource_reparse_candidate")),
