...
def show_governance_snapshot_status(*, core_q, prompt_utils, status_messages) -> None:
    ...
    print()
    menu_utils.print_header("Governance Snapshot Status")
    version = None
    sha = None
    row_count = 0
    try:
        version, sha, row_count = intel_db.latest_governance_snapshot()
    ...
    print()
    menu_utils.print_section("Import command")
    print("python -m scytaledroid.Database.tools.permission_governance_import \\")
