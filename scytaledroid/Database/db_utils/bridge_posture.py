...
_BRIDGE_POSTURES: tuple[BridgeTablePosture, ...] = (
    BridgeTablePosture(
        ...
        current_writers=(),
        current_readers=(
            "Database/db_utils/menus/query_runner (informational COUNT)",
            "Database/db_scripts/static_run_audit (optional mirror id)",
            "StaticAnalysis/cli/execution/db_verification (optional mirror COUNT)",
    ...
    BridgeTablePosture(
        ...
        current_writers=(),
        current_readers=(
            "StaticAnalysis/cli/persistence/reports/masvs_summary_report (env-gated fallback)",
            "scripts/db/audit_static_session.py",
