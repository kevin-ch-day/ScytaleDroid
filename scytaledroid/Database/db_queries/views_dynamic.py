...
SELECT
  ...
  nf.direction_outbound_bytes,
  nf.direction_inbound_bytes,
  nf.direction_unknown_bytes,
  nf.direction_outbound_packets,
  nf.direction_inbound_packets,
  nf.direction_unknown_packets,
  nf.flow_count,
  nf.tcp_stream_count,
  nf.udp_flow_count,
  nf.active_second_count,
  nf.burst_count,
  nf.max_burst_duration_s,
  nf.median_burst_duration_s,
  nf.median_interburst_gap_s,
  nf.outbound_packet_ratio,
  nf.inbound_packet_ratio,
  nf.outbound_byte_ratio,
  nf.inbound_byte_ratio,
  nf.direction_confident_packet_ratio,
  nf.active_second_ratio,
  nf.bursts_per_min,
  nf.median_packets_per_flow,
  nf.median_bytes_per_flow,
  nf.top_flow_packet_share,
  nf.top_flow_byte_share,
  nf.tls_handshakes_per_min,
  nf.tcp_reset_stream_ratio,
  nf.tcp_clean_close_stream_ratio,
  nf.tcp_partial_stream_ratio,
  nf.tcp_issue_stream_ratio,
  nf.top1_ja3_share,
  nf.top1_ja4_share,
  nf.top1_ja3s_share,
  nf.tls_visible,
  nf.tls_handshake_packets,
  nf.tls_client_hello_packets,
  nf.tls_server_hello_packets,
  nf.tls_sni_unique_count,
  nf.tls_alpn_unique_count,
  nf.quic_candidate_packets,
  nf.tcp_issue_packet_count,
  nf.tcp_reset_packet_count,
  nf.tcp_stream_count_lifecycle,
  nf.tcp_handshake_seen_stream_count,
  nf.tcp_issue_stream_count,
  nf.tcp_reset_stream_count,
  nf.tcp_clean_close_stream_count,
  nf.tcp_partial_stream_count,
