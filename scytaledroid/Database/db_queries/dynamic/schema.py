...
_DDL_STATEMENTS: list[str] = [
    ...
    CREATE TABLE IF NOT EXISTS dynamic_sessions (
      ...
      baseline_not_idle  TINYINT(1)   DEFAULT NULL,
      baseline_not_idle_reasons_json JSON DEFAULT NULL,
    ...
    ALTER TABLE dynamic_sessions
      ...
      ADD COLUMN IF NOT EXISTS baseline_not_idle TINYINT(1) DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS baseline_not_idle_reasons_json JSON DEFAULT NULL,
    ...
    CREATE TABLE IF NOT EXISTS dynamic_network_features (
      ...
      direction_outbound_bytes BIGINT    DEFAULT NULL,
      direction_inbound_bytes BIGINT     DEFAULT NULL,
      direction_unknown_bytes BIGINT     DEFAULT NULL,
      direction_outbound_packets INT      DEFAULT NULL,
      direction_inbound_packets INT       DEFAULT NULL,
      direction_unknown_packets INT       DEFAULT NULL,
      flow_count         INT             DEFAULT NULL,
      tcp_stream_count   INT             DEFAULT NULL,
      udp_flow_count     INT             DEFAULT NULL,
      active_second_count INT            DEFAULT NULL,
      burst_count        INT             DEFAULT NULL,
      max_burst_duration_s DOUBLE        DEFAULT NULL,
      median_burst_duration_s DOUBLE     DEFAULT NULL,
      median_interburst_gap_s DOUBLE     DEFAULT NULL,
      outbound_packet_ratio DOUBLE       DEFAULT NULL,
      inbound_packet_ratio DOUBLE        DEFAULT NULL,
      outbound_byte_ratio DOUBLE         DEFAULT NULL,
      inbound_byte_ratio DOUBLE          DEFAULT NULL,
      direction_confident_packet_ratio DOUBLE DEFAULT NULL,
      active_second_ratio DOUBLE         DEFAULT NULL,
      bursts_per_min DOUBLE              DEFAULT NULL,
      median_packets_per_flow DOUBLE     DEFAULT NULL,
      median_bytes_per_flow DOUBLE       DEFAULT NULL,
      top_flow_packet_share DOUBLE       DEFAULT NULL,
      top_flow_byte_share DOUBLE         DEFAULT NULL,
      tls_handshakes_per_min DOUBLE      DEFAULT NULL,
      tcp_reset_stream_ratio DOUBLE      DEFAULT NULL,
      tcp_clean_close_stream_ratio DOUBLE DEFAULT NULL,
      tcp_partial_stream_ratio DOUBLE    DEFAULT NULL,
      tcp_issue_stream_ratio DOUBLE      DEFAULT NULL,
      top1_ja3_share DOUBLE             DEFAULT NULL,
      top1_ja4_share DOUBLE             DEFAULT NULL,
      top1_ja3s_share DOUBLE            DEFAULT NULL,
      tls_visible        TINYINT(1)      DEFAULT NULL,
      tls_handshake_packets INT          DEFAULT NULL,
      tls_client_hello_packets INT       DEFAULT NULL,
      tls_server_hello_packets INT       DEFAULT NULL,
      tls_sni_unique_count INT           DEFAULT NULL,
      tls_alpn_unique_count INT          DEFAULT NULL,
      quic_candidate_packets INT         DEFAULT NULL,
      tcp_issue_packet_count INT         DEFAULT NULL,
      tcp_reset_packet_count INT         DEFAULT NULL,
      tcp_stream_count_lifecycle INT     DEFAULT NULL,
      tcp_handshake_seen_stream_count INT DEFAULT NULL,
      tcp_issue_stream_count INT         DEFAULT NULL,
      tcp_reset_stream_count INT         DEFAULT NULL,
      tcp_clean_close_stream_count INT   DEFAULT NULL,
      tcp_partial_stream_count INT       DEFAULT NULL,
      tls_client_hello_count INT         DEFAULT NULL,
      tls_server_hello_count INT         DEFAULT NULL,
      unique_ja3_count INT               DEFAULT NULL,
      unique_ja4_count INT               DEFAULT NULL,
      unique_ja3s_count INT              DEFAULT NULL,
    ...
    ALTER TABLE dynamic_network_features
      ...
      ADD COLUMN IF NOT EXISTS direction_outbound_bytes BIGINT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS direction_inbound_bytes BIGINT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS direction_unknown_bytes BIGINT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS direction_outbound_packets INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS direction_inbound_packets INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS direction_unknown_packets INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS flow_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tcp_stream_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS udp_flow_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS active_second_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS burst_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS max_burst_duration_s DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS median_burst_duration_s DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS median_interburst_gap_s DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS outbound_packet_ratio DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS inbound_packet_ratio DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS outbound_byte_ratio DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS inbound_byte_ratio DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS direction_confident_packet_ratio DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS active_second_ratio DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS bursts_per_min DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS median_packets_per_flow DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS median_bytes_per_flow DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS top_flow_packet_share DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS top_flow_byte_share DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tls_handshakes_per_min DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tcp_reset_stream_ratio DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tcp_clean_close_stream_ratio DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tcp_partial_stream_ratio DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tcp_issue_stream_ratio DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS top1_ja3_share DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS top1_ja4_share DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS top1_ja3s_share DOUBLE DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tls_visible TINYINT(1) DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tls_handshake_packets INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tls_client_hello_packets INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tls_server_hello_packets INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tls_sni_unique_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tls_alpn_unique_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS quic_candidate_packets INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tcp_issue_packet_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tcp_reset_packet_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tcp_stream_count_lifecycle INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tcp_handshake_seen_stream_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tcp_issue_stream_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tcp_reset_stream_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tcp_clean_close_stream_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tcp_partial_stream_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tls_client_hello_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS tls_server_hello_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS unique_ja3_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS unique_ja4_count INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS unique_ja3s_count INT DEFAULT NULL;
    """,
]
