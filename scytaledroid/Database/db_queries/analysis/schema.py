...
CREATE_WEB_STATIC_DYNAMIC_APP_SUMMARY_CACHE = """
    CREATE TABLE IF NOT EXISTS web_static_dynamic_app_summary_cache (
      package_name                    VARCHAR(255) NOT NULL,
      app_label                       VARCHAR(255) DEFAULT NULL,
      category                        VARCHAR(191) DEFAULT NULL,
      profile_key                     VARCHAR(64)  DEFAULT NULL,
      profile_label                   VARCHAR(191) DEFAULT NULL,
      latest_apk_id                   BIGINT UNSIGNED DEFAULT NULL,
      latest_version_name             VARCHAR(191) DEFAULT NULL,
      latest_version_code             VARCHAR(64)  DEFAULT NULL,
      latest_harvested_at             DATETIME     DEFAULT NULL,
      latest_static_run_id            BIGINT UNSIGNED DEFAULT NULL,
      latest_static_session_stamp     VARCHAR(255) DEFAULT NULL,
      static_source_state             VARCHAR(64)  DEFAULT NULL,
      static_high                     INT          DEFAULT NULL,
      static_med                      INT          DEFAULT NULL,
      static_low                      INT          DEFAULT NULL,
      static_info                     INT          DEFAULT NULL,
      permission_audit_grade          VARCHAR(16)  DEFAULT NULL,
      permission_audit_score_capped   DECIMAL(10,3) DEFAULT NULL,
      permission_audit_dangerous_count INT         DEFAULT NULL,
      permission_audit_signature_count INT         DEFAULT NULL,
      permission_audit_vendor_count   INT          DEFAULT NULL,
      latest_dynamic_run_id           CHAR(36)     DEFAULT NULL,
      ...
      dynamic_feature_recency_state   VARCHAR(64)  DEFAULT NULL,
      latest_feature_dynamic_run_id   CHAR(36)     DEFAULT NULL,
      dynamic_bytes_per_sec           DOUBLE       DEFAULT NULL,
      dynamic_packets_per_sec         DOUBLE       DEFAULT NULL,
      regime_dynamic_score            DOUBLE       DEFAULT NULL,
      regime_final_label              VARCHAR(64)  DEFAULT NULL,
      regime_created_at_utc           DATETIME     DEFAULT NULL,
      has_static_data                 TINYINT(1)   DEFAULT NULL,
      has_dynamic_data                TINYINT(1)   DEFAULT NULL,
      has_regime_data                 TINYINT(1)   DEFAULT NULL,
      summary_state                   VARCHAR(64)  DEFAULT NULL,
      materialized_at_utc             DATETIME     NOT NULL,
      PRIMARY KEY (package_name),
      KEY idx_wsdsac_profile (profile_key),
      KEY idx_wsdsac_summary_state (summary_state),
...
_DDL_STATEMENTS: list[str] = [
    ...
    CREATE TABLE IF NOT EXISTS analysis_dynamic_cohort_status (
      ...
      package_name_lc        VARCHAR(255) DEFAULT NULL,
      version_name           VARCHAR(191) DEFAULT NULL,
      version_code           BIGINT       DEFAULT NULL,
      base_apk_sha256        CHAR(64)     DEFAULT NULL,
      artifact_set_hash      CHAR(64)     DEFAULT NULL,
      signer_set_hash        CHAR(64)     DEFAULT NULL,
      signer_primary_digest  CHAR(64)     DEFAULT NULL,
      static_handoff_hash    CHAR(64)     DEFAULT NULL,
      freeze_manifest_sha256 CHAR(64)     DEFAULT NULL,
      paper_contract_version INT          DEFAULT NULL,
      reason_taxonomy_version INT         DEFAULT NULL,
      plan_schema_version    VARCHAR(32)  DEFAULT NULL,
      freeze_contract_version INT         DEFAULT NULL,
      ml_schema_version      INT          DEFAULT NULL,
      identity_check_status  VARCHAR(16)  DEFAULT NULL,
      identity_checked_at_start_utc DATETIME DEFAULT NULL,
      identity_checked_at_end_utc   DATETIME DEFAULT NULL,
      identity_checked_at_gate_utc  DATETIME DEFAULT NULL,
      identity_start_json    JSON         DEFAULT NULL,
      identity_end_json      JSON         DEFAULT NULL,
      identity_gate_json     JSON         DEFAULT NULL,
      paper_eligible         TINYINT(1)   DEFAULT NULL,
    ...
    """,
    """
    ALTER TABLE analysis_dynamic_cohort_status
      ADD COLUMN IF NOT EXISTS package_name_lc VARCHAR(255) DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS version_name VARCHAR(191) DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS version_code BIGINT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS artifact_set_hash CHAR(64) DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS signer_set_hash CHAR(64) DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS signer_primary_digest CHAR(64) DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS paper_contract_version INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS reason_taxonomy_version INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS plan_schema_version VARCHAR(32) DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS freeze_contract_version INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS ml_schema_version INT DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS identity_check_status VARCHAR(16) DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS identity_checked_at_start_utc DATETIME DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS identity_checked_at_end_utc DATETIME DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS identity_checked_at_gate_utc DATETIME DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS identity_start_json JSON DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS identity_end_json JSON DEFAULT NULL,
      ADD COLUMN IF NOT EXISTS identity_gate_json JSON DEFAULT NULL,
