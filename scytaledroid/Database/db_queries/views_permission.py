...
SELECT ar.package_name,
       ...
       NULL AS app_id,
       ar.sha256,
       CONVERT(rs.session_stamp USING utf8mb4) COLLATE utf8mb4_unicode_ci AS session_stamp,
       rs.scope_label,
       rs.risk_score,
       rs.risk_score AS permission_posture_score,
       rs.risk_grade,
       rs.risk_grade AS permission_posture_grade,
       rs.dangerous,
       rs.signature,
       rs.vendor,
       ar.version_name,
