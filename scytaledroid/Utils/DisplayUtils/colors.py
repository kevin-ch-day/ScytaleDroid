...
class Palette:
    ...
    info: Tuple[str, ...] = ("38;5;45",)
    success: Tuple[str, ...] = ("38;5;82",)
    warning: Tuple[str, ...] = ("38;5;220",)
    error: Tuple[str, ...] = ("38;5;203",)
    accent: Tuple[str, ...] = ("38;5;213",)
    muted: Tuple[str, ...] = ("38;5;244",)
    header: Tuple[str, ...] = ("1", "38;5;117")
    divider: Tuple[str, ...] = ("38;5;240",)
    option_key: Tuple[str, ...] = ("1", "38;5;81")
    option_default: Tuple[str, ...] = ("1", "38;5;214")
    option_text: Tuple[str, ...] = ("38;5;251",)
    hint: Tuple[str, ...] = ("38;5;111",)
    highlight: Tuple[str, ...] = ("1", "48;5;237", "38;5;153")
