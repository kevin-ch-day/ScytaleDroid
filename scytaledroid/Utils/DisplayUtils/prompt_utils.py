...
def _safe_input(rendered_prompt: str) -> str | None:
    """Read a line of input, returning ``None`` when stdin is exhausted."""
...
def get_choice(
    ...
    *,
    ...
    while True:
        raw_response = _safe_input(rendered_prompt)
...
def prompt_yes_no(prompt: str, *, default: bool = False) -> bool:
    ...
    while True:
        raw_answer = _safe_input(rendered_prompt)
