...
def render_cohort_status_help() -> None:
    ...
    print("Status   = workflow state only: complete, review, manual, baseline, legacy, restore, refresh, or blocked.")
    ...
    print("Evidence = evidence lineage: local+db, db-only, local-only, empty, or none.")
