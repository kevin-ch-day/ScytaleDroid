                ...
                manifest.operator.update(
                    {
                        ...
                        "call_primary_outcome_reason": protocol.get("call_primary_outcome_reason"),
                        "call_attempt_count": protocol.get("call_attempt_count"),
                        "call_connected_count": protocol.get("call_connected_count"),
                        "call_not_connected_count": protocol.get("call_not_connected_count"),
                        "call_connected_short_count": protocol.get("call_connected_short_count"),
                        "call_canceled_count": protocol.get("call_canceled_count"),
                        "call_outcome_summary": protocol.get("call_outcome_summary"),
                        "call_outcome_events": protocol.get("call_outcome_events"),
                        "call_activity_inferred_from_foreground": protocol.get(
                            "call_activity_inferred_from_foreground"
                        ),
                        "call_activity_original_tag": protocol.get("call_activity_original_tag"),
    ...
    def _build_manifest(
        ...
        manifest = RunManifest(
            ...
            operator={
                ...
                "call_primary_outcome_reason": None,
                "call_attempt_count": None,
                "call_connected_count": None,
                "call_not_connected_count": None,
                "call_connected_short_count": None,
                "call_canceled_count": None,
                "call_outcome_summary": None,
                "call_outcome_events": None,
                "call_activity_inferred_from_foreground": None,
                "call_activity_original_tag": None,
                "call_activity_foreground_component": None,
